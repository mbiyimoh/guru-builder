...
// Force dynamic rendering to ensure fresh data (especially for recommendations)
// This is critical because recommendations are generated asynchronously after research completes
...
export default async function ResearchRunDetailPage({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Running Status with Auto-Refresh */}
      {run.status === 'RUNNING' && (
