      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-card rounded-lg border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-muted-foreground">Context Layers</p>
              <p className="text-2xl font-semibold">{project.contextLayers.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-lg border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold">{project.knowledgeFiles.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-lg border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-muted-foreground">Research Runs</p>
              <p className="text-2xl font-semibold">{project.researchRuns.length}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-lg border mb-8">
        ...
        {project.researchRuns.length === 0 ? (
          <div className="px-6 py-12 text-center">
            ...
            <h3 className="mt-2 text-sm font-medium">No research runs yet</h3>
            <p className="mt-1 text-sm text-muted-foreground">Get started by creating your first research run.</p>
          </div>
        ) : (
          <div className="divide-y">
            {project.researchRuns.map((run) => (
              <Link
                ...
                className="block px-6 py-4 hover:bg-accent"
              >
