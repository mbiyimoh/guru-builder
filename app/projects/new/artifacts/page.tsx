...
/**
 * Legacy Artifacts Wizard Route - Redirect Only
 *
 * This route is deprecated. All traffic is redirected to the new
 * dashboard-anchored route: /projects/[id]/artifacts/teaching
 *
...
export default function LegacyArtifactsPage() {
  ...
  useEffect(() => {
    if (projectId) {
      router.replace(`/projects/${projectId}/artifacts/teaching`);
    } else {
